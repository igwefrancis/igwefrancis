...
I'm a Data Analyst with 5+ years of experience turning data into actionable business strategies. I specialize in **SQL, Excel, Power BI, and Python**.

I build dashboards and analysis that go beyond charts — connecting the numbers to real business decisions around sales, procurement, workforce, and customer behaviour.

📧 igwefrancisnchedo@gmail.com  
📍 Sheffield, UK  
...
### 🛠 Tools & Technologies
`SQL` `Python` `Power BI` `Excel` `Power Query` `DAX`
